...
;public      CDCControlDscr, CDCControlDscrEnd, CDCDataDscr, CDCDataDscrEnd
...
db    2      ;  /* Configuration descriptor type */
db    0C6H
db 		0         ;             /* Length of this descriptor and all sub descriptors */
...
db   8 ;  /* Descriptor size */
db    0BH    ;  /* Interface association descr type */
db        0                         ;  /* I/f number of first video control i/f */
db        2                         ;  /* Number of video streaming i/f */
db        0EH                         ;  /* CC_VIDEO : Video i/f class code */
db        3                         ;  /* SC_VIDEO_INTERFACE_COLLECTION : subclass code */
db        0                         ;  /* Protocol : not used */
db    0x00                         ;  /* String desc index for interface */

;/* Standard video control interface descriptor */
db    9                          ; /* Descriptor size */
db    4       ; /* Interface descriptor type */
db    0                          ; /* Interface number */
db    0                          ; /* Alternate setting number */
db    1                          ; /* Number of end points */
db    0Eh                          ; /* CC_VIDEO : Interface class */
db    1                          ; /* CC_VIDEOCONTROL : Interface sub class */
db    0                          ; /* Interface protocol code */
db    0                          ; /* Interface descriptor string index */

;/* Class specific VC interface header descriptor */
db    0Dh                         ;  /* Descriptor size */
db    24h                         ;  /* Class Specific I/f header descriptor type */
db    0                         ;  /* Descriptor sub type : VC_HEADER */
db    0
db    1                    ;  /* Revision of class spec : 1.0 */
db    50H
db    0                    ;  /* Total size of class specific descriptors (till output terminal) */
db    0
db    6CH
db    0DCH
db    2          ;  /* Clock frequency : 48MHz */
db    1                         ;  /* Number of streaming interfaces */
db    1                         ;  /* Video streaming I/f 1 belongs to VC i/f */
...
db    5   ;   /* Endpoint descriptor type */
db    82H   ;   /* Endpoint address and description */
db    3       ;   /* Interrupt end point type */
db    40H
...
db    81H        ;      /* EP address for ISO video data */
...
db    07H                          ; /* Descriptor size */
db    5       ; /* Endpoint descriptor type */
db    81H           ; /* Endpoint address and description */
db    05H                          ; /* ISO End point : Async */
db    0 ; /* 1 transaction per microframe */
db    4 ; /* CY_FX_EP_ISO_VIDEO_PKT_SIZE max bytes */
