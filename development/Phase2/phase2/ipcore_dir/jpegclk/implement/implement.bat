...
xst -ifn xst.scr
move jpegclk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\jpegclk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc jpegclk_exdes.ucf jpegclk_exdes

echo 'Running map'
map -timing -pr b jpegclk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm jpegclk_exdes -w routed.ncd routed.vhd
cd ..
