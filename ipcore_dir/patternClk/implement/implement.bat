...
xst -ifn xst.scr
move patternClk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\patternClk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc patternClk_exdes.ucf patternClk_exdes

echo 'Running map'
map -timing -pr b patternClk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm patternClk_exdes -w routed.ncd routed.vhd
cd ..
