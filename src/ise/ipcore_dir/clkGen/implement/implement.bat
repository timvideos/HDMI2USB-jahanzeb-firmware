...
xst -ifn xst.scr
move clkGen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkGen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkGen_exdes.ucf clkGen_exdes

echo 'Running map'
map -timing -pr b clkGen_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clkGen_exdes -w routed.ncd routed.vhd
cd ..
